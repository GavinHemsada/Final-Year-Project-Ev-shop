...
export const ServiceIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const EnvelopeOpenIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    className={className}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
export const EvCheckIcon: React.FC = () => (
  <svg
    className="w-5 h-5"
    fill="none"
    stroke="currentColor"
...
export const PhotographIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
